...
public class CheckoutRoundFragment extends Fragment {
    ...
    public Dialog bookFlightDialog() {
        ...
        builder.setMessage("Hvala za naročilo, uživajte ob poletu... ")
                .setCancelable(false)
    ...
    public Dialog roundFlightAlreadyBookedAlert() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        builder.setMessage("Ste že rezervirali odhodni ali povratni let. Izberite drug let in poskusite znova.")
                .setCancelable(false)
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
