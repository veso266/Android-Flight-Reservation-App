package si.wolf.planea.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void updateDatabase(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 1) {
            ...
            insertAirline(db, "Adria Airways");
            insertAirline(db, "Croatia Airlines");
            insertAirline(db, "FlyBosnia");
            insertAirline(db, "Air Serbia");
            ...
            //Ljubljana to Zagreb
            insertFlight(db, "Ljubljana", "Zagreb", "2022-8-10", "2022-8-10", "10:10", "12:10", 200.00, 1);
            insertFlight(db, "Ljubljana", "Zagreb", "2022-8-10", "2022-8-10", "10:10", "12:10", 150.00, 2);
            insertFlight(db, "Ljubljana", "Zagreb", "2022-8-10", "2022-8-10", "11:10", "12:10", 350.00, 3);
            insertFlight(db, "Ljubljana", "Zagreb", "2022-8-10", "2022-8-10", "09:10", "12:10", 250.00, 4);
            insertFlight(db, "Ljubljana", "Zagreb", "2022-8-10", "2022-8-10", "10:10", "12:10", 100.00, 5);

            //Zagreb to Ljubljana
            insertFlight(db, "Zagreb", "Ljubljana", "2022-8-12", "2022-8-12", "10:10", "12:10", 120.00, 6);
            insertFlight(db, "Zagreb", "Ljubljana", "2022-8-12", "2022-8-12", "09:00", "12:10", 150.00, 7);
            insertFlight(db, "Zagreb", "Ljubljana", "2022-8-12", "2022-8-12", "10:10", "12:10", 170.00, 8);
            insertFlight(db, "Zagreb", "Ljubljana", "2022-8-12", "2022-8-12", "09:00", "12:10", 140.00, 9);
            insertFlight(db, "Zagreb", "Ljubljana", "2022-8-12", "2022-8-12", "09:00", "12:10", 100.00, 10);
            insertFlight(db, "Zagreb", "Ljubljana", "2022-8-12", "2022-8-12", "10:10", "12:10", 350.00, 11);
            ...
            insertFlightClass(db, "Ekonomski");
            insertFlightClass(db, "Poslovni");
            insertFlightClass(db, "1. Razred");

            insertClient(db, "Mitja", "Kocjančič", "051355895", "1998-6-26", "5412547854125963");

            insertAccount(db, "veso266@gmail.com", "stranisce", 1);
    ...
    public static void insertClient(SQLiteDatabase db, String firstName, String lastName, String phone, String birthdate, String creditCard) {
        ...
        clientValues.put("DATEOFBIRTH", birthdate);
    ...
    public static Cursor selectClientJoinAccount(SQLiteDatabase db, int clientID) {
        return db.rawQuery("SELECT FIRSTNAME, LASTNAME, PHONE, CREDITCARD, DATEOFBIRTH, EMAIL FROM CLIENT " +
                "JOIN ACCOUNT " +
    ...
    public static final String[] CITIES = new String[] {
            "Ljubljana", "Zagreb", "Edmonton", "Winnipeg", "Victoria",
